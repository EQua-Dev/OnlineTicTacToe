...
/*
* Function to draw an X on the field
* */
...
/*
* Function to draw an O on the field
* */
...
/*
* Function to draw the field cells for the board
* NOTE:
* Canvas works with pixels and not dp
* Its usually best to calculate the positions to place (draw) items in respect to the size of the screen
* */
